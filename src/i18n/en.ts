const en = {
  ...
  myTicketsSub: 'See replies and solved status',
  noTicketsYet: 'You have not raised any tickets yet.',
  supportReply: 'Support reply',
  waitingForSupport: 'Waiting for support reply…',
  ticketOpen: 'Open',
  ticketInProgress: 'In progress',
  ticketSolved: 'Solved',
  shareFeedback: 'Share Feedback',
  reviewApplication: 'Review Application',
  donationForm: 'Offering Form',
  ...
  donationConfirmed: 'Offering Confirmed',
  ...
  donationDetails: 'Offering details',
  ...
  donationReceived: 'Offering received',
